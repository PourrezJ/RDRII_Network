    ...
    internal partial class GameServer
    {
        public void ProcessMessages()
        {
            ...
            for (var index1 = 0; index1 < count; index1++)
            {
                ...
                if (client == null)
                    client = new Client(API.Shared, new NetHandle(Program.ServerInstance.NetEntityHandler.GeneratePedHandle()), msg.SenderConnection);
                    ...
                    switch (msg.MessageType)
                    {
                        ...
                        case NetIncomingMessageType.ConnectionApproval:
                        {
                            ...
                            lock (Clients)
                            {
                                ...
                                while (AllowDisplayNames && Clients.Any(c => c.NameInternal == connReq.DisplayName))
                                {
                                    duplicate++;
                           ...
                           // client.MediaStream = connReq.MediaStream;
                            client.NameInternal = AllowDisplayNames ? connReq.DisplayName : connReq.SocialClubName;
                           ...
                           /* if (!AllowCEFDevTool && connReq.CEFDevtool)
                            ...
                            var respObj = new ConnectionResponse
                            {
                                ...
                                CharacterHandle = client.Id.Value,
                            ...
                            Program.Output("Processing connection: " + client.SocialClubName + " (" + client.NameInternal + ") [" + client.NetConnection.RemoteEndPoint.Address + "]");
                        }
                            break;
                            ...
                            switch (newStatus)
                            {
                                ...
                                case NetConnectionStatus.Disconnected:
                                {
                                    ...
                                    if (Clients.Contains(client))
                                    {
                                        ...
                                        lock (Clients)
                                        {
                                            var dcObj = new PlayerDisconnect() { Id = client.Id.Value };
                                            ...
                                            Server.Configuration.CurrentPlayers = Clients.Count;
                                            NetEntityHandler.DeleteEntityQuiet(client.Id.Value);
                            ...
                            switch (packetType)
                            {
                                        ...
                                        if (data != null)
                                        {
                                            ...
                                            ThreadPool.QueueUserWorkItem(delegate
                                            {
                                                ...
                                                if (pass)
                                                {
                                                    ...
                                                    data.Sender = client.NameInternal;
                                ...
                                case PacketType.VehiclePureSync:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (fullPacket.PlayerHealth.Value != client.HealthInternal)
                                        {
                                            lock (RunningResources)
                                                RunningResources.ForEach(fs => fs.Engines.ForEach(en =>
                                                {
                                                    en.InvokePlayerHealthChange(client, client.HealthInternal);
                                                }));
                                        }

                                        if (fullPacket.PedArmor.Value != client.ArmorInternal)
                                        {
                                            lock (RunningResources)
                                                RunningResources.ForEach(fs => fs.Engines.ForEach(en =>
                                                {
                                                    en.InvokePlayerArmorChange(client, client.ArmorInternal);
                                                }));
                                        }
                                        ...
                                        client.HealthInternal = fullPacket.PlayerHealth.Value;
                                        client.ArmorInternal = fullPacket.PedArmor.Value;
                                        ...
                                        {
                                            client.PositionInternal = fullPacket.Position;
                                        ...
                                        UpdateAttachables(client.Id.Value);
                                ...
                                case PacketType.VehicleLightSync:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (!client.IsInVehicle || client.VehicleHandleInternal != car.Value)
                                        {
                                ...
                                case PacketType.PedPureSync:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        var oldHealth = client.HealthInternal;
                                        var oldArmor = client.ArmorInternal;
                                        ...
                                        if (client.IsInVehicle && !client.CurrentVehicle.IsNull)
                                        {
                                ...
                                case PacketType.PedLightSync:
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (NetEntityHandler.ToDict().ContainsKey(fullPacket.NetHandle.Value))
                                        {
                                            ...
                                            Console.WriteLine($"{client.Position.X} {client.Position.Y} {client.Position.Z}");
                                        ResendPacket(fullPacket, client, false);
                                    }
                                    catch (IndexOutOfRangeException)
                                    {
                                ...
                                case PacketType.PlayerKilled:
                                {
                                    ...
                                    client.SetData("__LAST_PLAYER_DEATH", PublicAPI.TickCount);
                                }
                                    break;
                                ...
                                case PacketType.PlayerRespawned:
                                {
                                    ...
                                    lock (RunningResources)
                                    {
                                      ...
                                      client.SetData("__LAST_PLAYER_RESPAWN", PublicAPI.TickCount);
                                }
                                 break;
