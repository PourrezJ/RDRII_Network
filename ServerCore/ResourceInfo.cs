...
namespace ResuMPServer
{
    ...
    internal class ScriptingEngine
    {
        ...
        {
            lock (_mainQueue.SyncRoot)
            _mainQueue.Enqueue(new Action(async () =>
            {
                if (Language == ScriptingEngineLanguage.compiled)
                {
                    await _compiledScript.API.InvokeResourceStart();
                }             
            }));
        }
        ...
        public void InvokeEntityDataChange(NetHandle ent, string key, object oldValue)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeOnEntityDataChange(ent, key, oldValue);
            }));
        }
        ...
        public void InvokePlayerEnterVehicle(Client client, NetHandle veh)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerEnterVeh(client, veh);
            }));
        }
        ...
        public void InvokeServerResourceStart(string resource)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeServerResourceStart(resource);
            }));
        }
        ...
        public void InvokeVehicleTrailerChange(NetHandle entity, NetHandle trailer)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleTrailerChange(entity, trailer);
            }));
        }
        ...
        public void InvokePlayerDetonateStickies(Client player)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerDetonateStickies(player);
            }));
        }
        ...
        public void InvokePlayerModelChange(Client player, int oldModel)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerModelChange(player, oldModel);
            }));
        }
        ...
        public void InvokeVehicleTyreBurst(NetHandle entity, int index)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleTyreBurst(entity, index);
            }));
        }
        ...
        public void InvokeVehicleDoorBreak(NetHandle entity, int index)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleDoorBreak(entity, index);
            }));
        }
        ...
        public void InvokeVehicleWindowBreak(NetHandle entity, int index)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleWindowBreak(entity, index);
            }));
        }
        ...
        public void InvokeVehicleSirenToggle(NetHandle entity, bool oldValue)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleSirenToggle(entity, oldValue);
            }));
        }
        ...
        public void InvokeVehicleHealthChange(NetHandle player, float oldValue)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleHealthChange(player, oldValue);
            }));
        }
        ...
        public void InvokePlayerWeaponChange(Client player, int oldValue)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerWeaponSwitch(player, oldValue);
            }));
        }
        ...
        public void InvokePlayerWeaponAmmoChange(Client player, int weapon, int oldValue)
        {
            lock (_mainQueue.SyncRoot)
                ...
                {
                    if (Language == ScriptingEngineLanguage.compiled)
                        await _compiledScript.API.invokePlayerWeaponAmmoChange(player, weapon, oldValue);
                }));
        }
        ...
        public void InvokePlayerArmorChange(Client player, int oldValue)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerArmorChange(player, oldValue);
            }));
        }
        ...
        public void InvokePlayerHealthChange(Client player, int oldValue)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerHealthChange(player, oldValue);
            }));
        }
        ...
        public void InvokeServerResourceStop(string resource)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeServerResourceStop(resource);
            }));
        }
        ...
        public void InvokePlayerExitVehicle(Client client, NetHandle veh)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerExitVeh(client, veh);
            }));
        }
        ...
        public void InvokeVehicleDeath(NetHandle veh)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeVehicleDeath(veh);
            }));
        }
        ...
        public void InvokeColshapeEnter(ColShape shape, NetHandle veh)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeColShapeEnter(shape, veh);
            }));
        }
        ...
        public void InvokeColshapeExit(ColShape shape, NetHandle veh)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeColShapeExit(shape, veh);
            }));
        }
        ...
        public void InvokeMapChange(string mapName, XmlGroup map)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeMapChange(mapName, map);
            }));
        }
        ...
        public void InvokePlayerDownloadFinished(Client client)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeFinishedDownload(client);
            }));
        }
        ...
        public void InvokePlayerPickup(Client client, NetHandle pickup)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerPickup(client, pickup);
            }));
        }
        ...
        public void InvokePickupRespawn(NetHandle pickup)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePickupRespawn(pickup);
            }));
        }

        public void InvokeChatCommand(Client sender, string command, CancelEventArgs ce)
        {
            Task cmdTask = Task.Run(async () =>
            {
                if (Language == ScriptingEngineLanguage.compiled)
                {
                   await  _compiledScript.API.invokeChatCommand(sender, command, ce);
                }
            });
        ...
        {
            Task<bool> shutdownTask = Task.Run<bool>(async () =>
            {
                try
                {
                    if (Language == ScriptingEngineLanguage.compiled)
                        return await _compiledScript.API.invokeChatMessage(sender, cmd);
                }
                catch (Exception ex)
                {
                    Program.Output("Unhandled exception caught in " + Filename + " from resource " +
        ...
        public void InvokeClientEvent(Client sender, string eventName, object[] args)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokeClientEvent(sender, eventName, args);
            }));
        }
        ...
        public void InvokePlayerConnected(Client sender)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerConnected(sender);
            }));
        }
        ...
        public void InvokePlayerDeath(Client killed, int reason, int weapon)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerDeath(killed, new NetHandle(reason), weapon);
            }));
        }
        ...
        public void InvokePlayerRespawn(Client sender)
        {
            ...
            {
                if (Language == ScriptingEngineLanguage.compiled)
                    await _compiledScript.API.invokePlayerRespawn(sender);
            }));
        }
