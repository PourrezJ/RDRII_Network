...
namespace RDRN_UI
{
    internal class WebKitInjector : CefRenderProcessHandler
    {
        ...
        */
        ...
        {
            Console.WriteLine("-> OnUncaughtException!");
