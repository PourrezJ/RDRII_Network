...
namespace Shared
{
    public class Matrix4
    {
        ...
        {
            var ret = Identity;
            ret.m11 = (float)System.Math.Cos(rot);
            ret.m12 = (float)-System.Math.Sin(rot);
            ret.m21 = (float)System.Math.Sin(rot);
            ret.m22 = (float)System.Math.Cos(rot);
            return ret;
        }
        ...
        {
            var ret = Identity;
            ret.m00 = (float)System.Math.Cos(rot);
            ret.m02 = (float)System.Math.Sin(rot);
            ret.m20 = (float)-System.Math.Sin(rot);
            ret.m22 = (float)System.Math.Cos(rot);
            return ret;
        }
        ...
        public static Matrix4 CreateRotationZ(float rot)
        {
            var ret = Identity;
            ret.m00 = (float)System.Math.Cos(rot);
            ret.m01 = (float)System.Math.Sin(rot);
            ret.m10 = (float)-System.Math.Sin(rot);
            ret.m11 = (float)System.Math.Cos(rot);
            return ret;
        }
