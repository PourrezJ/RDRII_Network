...
namespace RDRN_Core.Misc
{
    ...
    {
        public static bool IsWeaponAutomatic(Shared.WeaponHash hash)
        {
            switch (hash)
            {
                default:
                    return true;
                case Shared.WeaponHash.Molotov:
                case Shared.WeaponHash.BZGas:
                case Shared.WeaponHash.SmokeGrenade:
                case Shared.WeaponHash.ProximityMine:
                case Shared.WeaponHash.StickyBomb:
                case Shared.WeaponHash.Grenade:
                case Shared.WeaponHash.Flare:
                case Shared.WeaponHash.Snowball:
                case Shared.WeaponHash.Ball:
                case Shared.WeaponHash.Pipebomb:

                case Shared.WeaponHash.RPG:
                case Shared.WeaponHash.HomingLauncher:
                case Shared.WeaponHash.Railgun:
                case Shared.WeaponHash.GrenadeLauncher:
                case Shared.WeaponHash.Firework:
                case Shared.WeaponHash.Musket:
                case Shared.WeaponHash.FlareGun:
                case Shared.WeaponHash.CompactLauncher:
