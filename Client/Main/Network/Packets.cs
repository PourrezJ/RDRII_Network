...
namespace RDRN_Core
{
    public partial class Main
    {
        ...
        private void HandlePedPacket(PedData fullPacket, bool pure)
        {
            ...
            if (fullPacket.Position != null) syncPed.Position = fullPacket.Position;
            ...
            if (fullPacket.Quaternion != null) syncPed.Rotation = fullPacket.Quaternion;
            if (fullPacket.PlayerHealth != null) syncPed.PedHealth = fullPacket.PlayerHealth.Value;
            if (fullPacket.AimCoords != null) syncPed.AimCoords = fullPacket.AimCoords;
            ...
            if (fullPacket.Velocity != null) syncPed.PedVelocity = fullPacket.Velocity;
            ...
            if (fullPacket.Flag != null)
            {
                ...
                if ((fullPacket.Flag.Value & (int)PedDataFlags.ClosingVehicleDoor) != 0 && syncPed.MainVehicle != null)
                {
        ...
        private void HandleVehiclePacket(VehicleData fullData, bool purePacket)
        {
            ...
            {
                syncPed.Position = fullData.Position;
            }

            if (fullData.VehicleHandle != null) syncPed.VehicleNetHandle = fullData.VehicleHandle.Value;
            if (fullData.Velocity != null) syncPed.VehicleVelocity = fullData.Velocity;
            ...
            {
                syncPed.VehicleRotation = fullData.Quaternion;
            }
            ...
            if (fullData.Velocity != null) syncPed.Speed = fullData.Velocity.Length();
            /*
            ...
            if (fullData.AimCoords != null) syncPed.AimCoords = fullData.AimCoords;
            ...
            else if (syncPed.VehicleNetHandle != 00 && fullData.Position == null && fullData.Flag != null && !PacketOptimization.CheckBit(fullData.Flag.Value, VehicleDataFlags.Driver))
            {
                ...
                if (car != null)
                {
                    syncPed.Position = car.Position;
                    syncPed.VehicleRotation = car.Rotation;
                }
            }
