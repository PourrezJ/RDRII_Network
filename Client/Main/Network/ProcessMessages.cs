    ...
    public partial class Main
    {
                ...
                case PacketType.BasicSync:
                    {
                        ...
                        HandleBasicPacket(nethandle, position);
                    }
                    break;
                case PacketType.BulletSync:
                    {
                        ...
                        HandleBulletPacket(nethandle, shooting, position);
                    }
                    break;
                ...
                case PacketType.CreateEntity:
                    {
                        ...
                        if (DeserializeBinary<CreateEntity>(msg.ReadBytes(len)) is CreateEntity data && data.Properties != null)
                        {
                            ...
                            {
                                case (byte)Shared.EntityType.Vehicle:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.Prop:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.Blip:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.Marker:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.Pickup:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.TextLabel:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.Ped:
                                    {
                                    ...
                                    break;
                                case (byte)Shared.EntityType.Particle:
                                    {
                ...
                case PacketType.DeleteEntity:
                    {
                        ...
                        {
                            LogManager.WriteLog(LogLevel.Debug, "RECEIVED DELETE ENTITY " + data.NetHandle);
                ...
                case PacketType.FileTransferRequest:
                    {
                        ...
                        if (DeserializeBinary<DataDownloadStart>(msg.ReadBytes(len)) is DataDownloadStart data)
                        {
                            ...
                            LogManager.WriteLog(LogLevel.Debug, "FILE TYPE: " + (FileType)data.FileType);
                            LogManager.WriteLog(LogLevel.Debug, "DOWNLOAD ACCEPTED: " + acceptDownload);
                        ...
                        {
                            LogManager.WriteLog(LogLevel.Debug, "DATA WAS NULL ON REQUEST");
                        }
                    }
                    break;
                                ...
                                case ServerEventType.WeaponPermissionChange:
                                    {
                                        ...
                                        if (isSingleWeaponChange)
                                        {
                                            ...
                                            if (hasPermission) WeaponInventoryManager.Allow((Shared.WeaponHash)hash);
                                            else WeaponInventoryManager.Deny((Shared.WeaponHash)hash);
                                        }
                                        else
                                        {
                ...
                case PacketType.SyncEvent:
                    {
                        ...
                        if (data != null)
                        {
                            ...
                            if (args.Count > 0)
                                LogManager.WriteLog(LogLevel.Debug, "RECEIVED SYNC EVENT " + ((SyncEventType)data.EventType) + ": " + args.Aggregate((f, s) => f.ToString() + ", " + s.ToString()));
        ...
        public void ProcessMessages(NetIncomingMessage msg, bool safeThreaded)
        {
            ...
            catch (Exception e)
            {
                ...
                LogManager.Exception(e, "PROCESS MESSAGES (TYPE: " + msg.MessageType + " DATATYPE: " + type + ")");
            }
        }
