	...
	namespace Native
	{
		public enum Hash : ulong
		{
			...
			*/
			...
			_DOES_ANIM_SCENE_EXIST = 0x25557E324489393C, // 
			LOAD_ANIM_SCENE = 0xAF068580194D9DC7, // 
			_IS_ANIM_SCENE_LOADED = 0x477122B8D05E7968, // 
			_IS_ANIM_SCENE_LOADING = 0x59606519FF9D3EC2, // 
			_IS_ANIM_SCENE_METADATA_LOADED = 0x95531A4A20CCE7BC, // 
			...
			_IS_ANIM_SCENE_STARTED = 0xCBFC7725DE6CE2E0, // 
			_IS_ANIM_SCENE_FINISHED = 0xD8254CB2C586412B, // 
			_IS_ANIM_SCENE_ACTIVE = 0xCDC5512A407CF08D, // 
			...
			_GET_ANIM_SCENE_ORIGIN = 0xADF1D53F3B1FE0A7, // 
			...
			_GET_ANIM_SCENE_PROGRESS = 0x3FBC3F51BF12DFBF, // 
			...
			*/
			...
			_SET_PICKUP_OBJECT_GLOW_ENABLED = 0x7DFB49BCDB73089A, // 
			...
			_CREATE_BLOOD_POOLS_FROM_PED = 0xC349EE1E6EFA494B, // 
			...
			*/
			...
			/*
				INVENTORY
			*/
			_INVENTORY_GET_PED_INVENTORY_ID = 0x13D234A2A3F66E63, // 
			...
			*/
			...
			_BLIP_SET_MODIFIER = 0x662D364ABF16DE2F, // 
			...
			_SET_MINIMAP_FOW_REVEAL_VOLUME = 0x63CBBD6CA6F321F9, // 
			...
			*/
			...
			_IS_STRING_SPACE = 0x375F5870A7B8BEC1, // 
			...
			*/
			...
			_CAN_REGISTER_MISSION_PICKUPS = 0xF0460C7BF80011EA, // 
			...
			_NETWORK_IS_PLAYER_INDEX_VALID = 0x255A5EF65EDA9167, // 
			...
			*/
			...
			_SET_APPLY_OBJECT_TXD = 0xE124889AE0521FCF, // 
			/*
				PAD
			*/
			...
			*/
			...
			_GET_PED_DAMAGE = 0x88EFFED5FE8B0B4A, // 
			_SET_PED_DAMAGE = 0x7528720101A807A5, // 
			...
			_GET_PED_CROUCH_MOVEMENT = 0xD5FE956C70FF370B, // 
			...
			_IS_PED_USING_SCENARIO_HASH = 0x34D6AC1157C8226C, // 
			...
			_IS_PED_HOGTIED = 0x3AA24CCC0D451379, // 
			_IS_PED_HOGTYING = 0x42429C674B61238B, // 
			...
			_IS_PED_CARRYING = 0xA911EE21EDF69DAF, // 
			_IS_PED_LASSOED = 0x9682F850056C9ADE, // 
			_GET_LASSOED_ENTITY = 0xB65A4DAB460A19BD, // 
			...
			_SET_PED_COMPONENT_DISABLED = 0xD710A5007C2AC539, // 
			...
			_CHARGE_PED_STAMINA = 0xC3D4B754C0E86B9E, // 
			_GET_PED_STAMINA = 0x775A1CA7893AA8B5, // 
			_GET_PED_MAX_STAMINA = 0xCB42AFE2B613EE55, // 
			_RESTORE_PED_STAMINA = 0x675680D089BFA21F, // 
			_CREATE_PED_TEXTURE = 0xC5E7204F322E49EB, // 
			_OVERRIDE_TEXTURE_ON_PED = 0x0B46E25761519058, // 
			_DELETE_PED_TEXTURE = 0x6BEFAA907B076859, // 
			_UPDATE_PED_TEXTURE = 0x92DAABA2C1C10B0E, // 
			_RESET_PED_TEXTURE = 0x8472A1789478F82F, // 
			_IS_PED_TEXTURE_VALID = 0x31DC8D3F216D8509, // 
			_ADD_PED_OVERLAY = 0x86BB5FF45F193A02, // 
			_REMOVE_PED_OVERLAY = 0x96C349DE04C49011, // 
			_SEP_PED_OVERLAY_VARIATION = 0x3329AAE2882FC8E4, // 
			_SET_PED_OVERLAY_OPACITY = 0x6C76BC24F8BB709A, // 
			_SET_PED_OVERLAY_PALETTE = 0x1ED8588524AC9BE1, // 
			_SET_PED_OVERLAY_COLOUR = 0x2DF59FFE6FFD6044, // 
			_SET_PED_OVERLAY_TEXTURES = 0x253A63B5BADBC398, // 
			...
			*/
			...
			_DOES_SCENARIO_POINT_EXIST = 0x841475AC96E794D1, // 
			...
			_GET_SCENARIO_POINT_CLOSE_TO_COORDS = 0x345EC3B7EBDE1CB5, // 
			...
			_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE = 0xF533D68FF970D190, // 
			...
			*/
			...
			/*
				UIFEED
			*/
			_SHOW_TOOLTIP = 0x049D5C615BD38BAD, // 
			_SHOW_LOCATION_NOTIFICATION = 0xD05590C1AB38F068, // 
			_SHOW_OBJECTIVE = 0xCEDBF17EFCC0E4A4, // 
			_SHOW_SIMPLE_RIGHT_TEXT = 0xB2920B9760F0F36B, // 
			_SHOW_ADVANCED_NOTIFICATION = 0x26E87218390E6729, // 
			_SHOW_NOTIFICATION = 0xC927890AA64E9661, // 
			/*
				UILOG
			*/
			...
			*/
			...
			_IS_WEAPON_BOW = 0xC4DEC3CA8C365A5D, // 
			...
			_GET_WEAPON_CLIP_SIZE = 0xD3750CCC00635FC2, // 
			_IS_WEAPON_KNIFE = 0x792E3EF76C911959, // 
			_IS_WEAPON_REVOLVER = 0xC212F1D05A8232BB, // 
			_IS_WEAPON_PISTOL = 0xDDC64F5E31EEDAB6, // 
			_IS_WEAPON_REPEATER = 0xDDB2578E95EF7138, // 
			_IS_WEAPON_RIFLE = 0x0A82317B7EBFC420, // 
			_IS_WEAPON_SHOTGUN = 0xC75386174ECE95D5, // 
			_IS_WEAPON_SNIPER = 0x6AD66548840472E5, // 
			_IS_WEAPON_MELEE = 0x959383DCD42040DA, // 
			...
			_GET_WEAPON_DEGRADATION = 0x0D78E1097F89E637, // 
