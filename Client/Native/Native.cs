...
using Vector2 = Shared.Math.Vector2;
...
namespace RDRN_Core.Native
{
	...
	public static class Function
	{
		public static T Call<T>(Hash hash, params InputArgument[] arguments)
		{
			...
			unsafe
			{
				var res = NativeFunc.Invoke((ulong)hash, args);
		...
		public static void Call(Hash hash, params InputArgument[] arguments)
		{
			...
			unsafe
			{
				NativeFunc.Invoke((ulong)hash, args);
			}
		}
		...
		internal static unsafe object ObjectFromNative(Type type, ulong* value)
		{
			...
			{
				return NativeMemory.PtrToStringUTF8(new IntPtr((byte*)*value));
			}
