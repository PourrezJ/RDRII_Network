...
namespace RDRN_Core.Sync
{
    public partial class SyncPed
    {
        ...
        internal static Ped GetResponsiblePed(Vehicle veh)
        {
            ...
            if (veh.GetPedOnSeat(RDRN_Core.VehicleSeat.Driver).Handle != 0) return veh.GetPedOnSeat(RDRN_Core.VehicleSeat.Driver);

            for (int i = 0; i < veh.PassengerCount; i++)
            {
        ...
        internal int GetWeaponHandsHeld(int weapon)
        {
            switch (weapon)
            {
                ...
                case unchecked((int)WeaponHash.GolfClub):
                case unchecked((int)RDR2NetworkShared.WeaponHash.Poolcue):
                case unchecked((int)WeaponHash.Bat):
                    return 4;
                ...
                case unchecked((int)RDR2NetworkShared.WeaponHash.Wrench):
                case unchecked((int)RDR2NetworkShared.WeaponHash.Battleaxe):
                ...
                case unchecked((int)WeaponHash.BullpupShotgun):
                case unchecked((int)WeaponHash.SawnOffShotgun):
                case unchecked((int)RDR2NetworkShared.WeaponHash.Autoshotgun):
        ...
        internal string GetAnimalGetUpAnimation()
        {
            ...
            return (PedHash)ModelHash == PedHash.A_C_Boar_01 ? "creatures@boar@getup getup_l" : "anim@sports@ballgame@handball@ ball_get_up";
        }
