...
namespace RDRN_Core.Gui.DirectXHook
{
    public class DxHook
    {
        public DxHook()
        ...
        //Direct3D11
        internal static SharpDX.Direct3D11.Device Device11;
        internal static D3D11.DeviceContext DeviceContext11 { get; private set; }
        internal static D3D11.Device11On12 Device11on12 { get; private set; }
        ...
        static SharpDX.Direct2D1.RenderTarget[] d2DRenderTarget;
        ...
        public static RenderTarget CurrentRenderTarget2D1
        {
            get
            {
                if (d2DRenderTarget != null)
                    return d2DRenderTarget[frameIndex];
                return null;
            }
        }
        ...
        public SharpDX.Result PresentHook(IntPtr swapChainPtr, int syncInterval, DXGI.PresentFlags flags)
        {
            ...
            if (!init)
            {
                ...
                d2DRenderTarget = new SharpDX.Direct2D1.RenderTarget[buffersCounts];
                ...
                for (int i = 0; i < buffersCounts; i++)
                {
                    ...
                    d2DRenderTarget[i] = new SharpDX.Direct2D1.RenderTarget(d2dFactory, d2dSurface, new SharpDX.Direct2D1.RenderTargetProperties(new SharpDX.Direct2D1.PixelFormat(DXGI.Format.Unknown, SharpDX.Direct2D1.AlphaMode.Premultiplied)));
                    d2dSurface.Dispose();
                ...
                // initialize the D2D device
                DxgiDevice = Device11.QueryInterface<SharpDX.DXGI.Device>();
            ...
            CurrentRenderTarget2D1.BeginDraw();
...
*/
        ...
        public static SharpDX.Direct2D1.Bitmap GetBitmapFromTexture2D(SharpDX.Direct3D11.Texture2D texture, RenderTarget renderTarger)
        {
            ...
            using (var surface = copy.QueryInterface<DXGI.Surface>())
            {
